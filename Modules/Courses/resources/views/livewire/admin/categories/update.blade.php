            ...
            <form class="tk-themeform tk-form-blogcategories">
                <fieldset>
                    <div class="tk-themeform__wrap">
                        ...
                        <div class="form-group">
                            <label class="tb-label">{{ __('general.image') }} ({{ __('general.optional') }})</label>
                            <div class="tb-uploadarea">
                                <div class="tb-uploadbox">
                                    <input type="file" wire:model="image" id="image" accept="image/*" class="tb-uploadinput">
                                    <label for="image" class="tb-uploadlabel">
                                        <i class="icon-upload"></i>
                                        <span>{{ __('general.upload_file') }}</span>
                                        <em>{{ __('general.drag_drop') }}</em>
                                    </label>
                                </div>
                                @error('image')
                                    <div class="tk-errormsg">
                                ...
                                <div wire:loading wire:target="image" class="text-center">
                                    <span class="text-info">{{ __('general.uploading') }}...</span>
                                </div>
                            </div>
                        </div>
                        ...
                        @if(!empty($old_image))
                            <div class="form-group">
                                <label class="tb-label">{{ __('general.current_image') }}</label>
                                <div class="tb-uploadarea">
                                    <figure>
                                        <img src="{{ asset('storage/' . $old_image) }}" alt="Category Image" style="max-width: 100%; max-height: 150px;">
                                    </figure>
                                </div>
                            </div>
                        @endif
