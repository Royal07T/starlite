                                                    ...
                                                    <div class="cr-price-info">
                                                        @if($course->pricing?->pricing_type == 'session')
                                                            <div class="cr-discounted-price">
                                                                <span class="cr-price-amount">{!! formatAmount($course->pricing?->session_price, true) !!}</span>
                                                                <span style="font-size: 14px; color: #666;">/ {{ __('session') }}</span>
                                                            </div>
                                                        @elseif (isPaidSystem() && !empty($course->pricing?->price) && !empty($course->pricing?->final_price) && $course->pricing?->price != 0.00 )
