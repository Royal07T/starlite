                    ...
                    <div class="cr-card">
                        ...
                        <div class="cr-course-card">
                            ...
                            @if($data->sessions_remaining > 0)
                                <a href="{{ route('courses.student.course-booking', ['slug' => $course->slug]) }}" class="cr-start-course" style="margin-top: 10px; background-color: #28a745; border-color: #28a745;">
                                    {{ __('Book Session') }} ({{ $data->sessions_remaining }} Left)
                                </a>
                            @endif
                        </div>
                    </div>
