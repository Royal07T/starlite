...
class CourseBasicDetails extends Component
{
    ...
    public function createOrUpdateCourse()
    {
        ...
        try {
            ...
            // Track who created the course without automatically assigning ownership
            $validatedData['created_by'] = Auth::id();
            // Set a temporary instructor_id (current user) that can be changed later by admin
            $validatedData['instructor_id'] = Auth::id(); // Adding default instructor_id to prevent database error
