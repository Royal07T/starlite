...
class CoursePricing extends Component {
    ...
    public $min_sessions = null;
    public $pricing_type = 'course';
    ...
    public function mount() {
        ...
        if (!empty($this->course->pricing)) {
            ...
            $this->session_price    = $this->course?->pricing?->session_price;
            $this->min_sessions     = $this->course?->pricing?->min_sessions;
            $this->pricing_type     = $this->course?->pricing?->pricing_type ?? 'course';
    ...
    public function savePricing() {
        ...
        try {
            $data = [
                ...
                "session_price" => !empty($validatedData['session_price']) ? $validatedData['session_price'] : 0,
                "min_sessions" => !empty($validatedData['min_sessions']) ? $validatedData['min_sessions'] : null,
