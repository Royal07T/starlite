...
use App\Domain\Shared\FileUpload;
...
if (! function_exists('checkValidUTF8')) {
    ...
    function checkValidUTF8($string_text)
    {
        ...
        static $isUtf8 = null;
        if (! isset($isUtf8)) {
            $isUtf8 = in_array('UTF-8', ['utf8', 'utf-8', 'UTF8', 'UTF-8'], true);
        }
        ...
        if (@preg_match('/^./us', $string_text) === 1) {
            return $string_text;
        }
...
if (! function_exists('uniqueImageName')) {
    ...
    {
        return FileUpload::uniqueImageName($image, $uniqueString);
    }
}

if (! function_exists('joinExts')) {
    function joinExts($allowedExts = [], $withDot = false)
    {
        if ($withDot) {
...
if (! function_exists('uniqueFileName')) {
    ...
    {
        return FileUpload::uniqueFileName($fileUrl, $name);
    }
}
...
if (! function_exists('uploadImage')) {
    ...
    {
        return FileUpload::uploadBase64($dirName, $imageUrl);
    }
}
...
if (! function_exists('parseToUserTz')) {
    ...
    {
        return TimeZone::toUser($date, $timeZone);
    }
}
...
if (! function_exists('formatAmount')) {
    ...
    {
        return Currency::format($amount, $currencySuperscript);
    }
}
...
if (! function_exists('formatAmountWithoutDecimals')) {
    ...
    {
        return Currency::formatWithoutDecimals($amount, $currencySuperscript);
    }
}
...
if (! function_exists('formatAmountV2')) {
    ...
    {
        return Currency::formatV2($amount);
    }
}
...
if (! function_exists('getMeetingObject')) {
    function getMeetingObject(User $user)
    {
        ...
        if (! empty($service)) {
            ...
            if ($service == 'zoom' && ! empty($user) && $user instanceof User) {
...
if (! function_exists('isDemoSite')) {
    ...
    function isDemoSite()
    {
        ...
        if (in_array($serverName, ['lernen.amentotech.com'])) {
            return true;
        } else {
            return false;
        }
