...
class NotificationTemplates extends Component
{
    ...
    public function render(){
        ...
        foreach ($this->emailTemplates as &$template) {
            // Make sure info exists before accessing it
            $infoContent = isset($template['content']['info']) ? $template['content']['info'] : '';
            ...
            // Make sure subject exists before accessing it
            $subjectContent = isset($template['content']['subject']) ? $template['content']['subject'] : '';
            ...
            // Make sure content exists before accessing it
            $contentContent = isset($template['content']['content']) ? $template['content']['content'] : '';
            $template['content']['content'] = [
                'id' => 'content',
                'title' =>  __('notification_template.notification_content'),
                'default' => $contentContent,
            ];
        }
