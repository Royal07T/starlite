...
class Navigation extends Component
{
    ...
    public function mount()
    {
        ...
        $this->menuItems    = [
            ...
            // Commented out Find Tutors as requested
            // [
            //     'studentSortOrder' => 4,
            //     'route' => 'find-tutors',
            ...
            [
                'studentSortOrder' => 2,
                'route' => 'student.course-selector',
                'onActiveRoute' => ['student.course-selector'],
                'title' => __('Course Selector'),
        ...
        // Commented out Find Courses Bundles as requested
