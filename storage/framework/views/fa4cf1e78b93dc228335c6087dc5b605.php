...
$__html = app('livewire')->mount($__name, $__params, 'lw-1165207727-0', $__slots ?? [], get_defined_vars());
            ...
            document.addEventListener('DOMContentLoaded', (event) => {
                jQuery(document).on("click", '.update-section-settings', function(event){                
                    ...
                    let DoSpaceSettignsUrl   = `<?php echo e(!isDemoSite() && 
                                                \Nwidart\Modules\Facades\Module::has('dospaces') &&
                                                \Nwidart\Modules\Facades\Module::isEnabled('dospaces') &&
                                                Route::has('dospaces.dospace-settings') ? route('dospaces.dospace-settings') : null); ?>`;
                                ...
                                $.ajax({
                                    ...
                                    success: function(data){
                                        ...
                                        showAlert({
                                            message     : data.message,
                                            type        : data.success ? 'success' : 'error',
                                            title       : data.success ? <?php echo json_encode(__('dospaces::dospaces.success'), 15, 512) ?> : <?php echo json_encode(__('dospaces::dospaces.error'), 15, 512) ?>,
                                            autoclose   : 4000,
                                            redirectUrl : data.success ? location.href : false,
                                        });
                                    }
...
<?php /**PATH C:\wamp64\www\starlite\resources\views/layouts/admin-app.blade.php ENDPATH**/ ?>