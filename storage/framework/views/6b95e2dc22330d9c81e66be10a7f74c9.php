            ...
            <section class="cr-course-details-sections">
                ...
                <div class="cr-course-details-area">
                    ...
                    <div class="cr-course-sidebar">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(isPaidSystem() && !empty($course->pricing?->price) && !empty($course->pricing?->final_price) && $course->pricing?->price != 0.00 ): ?>
                                    <div class="cr-price-section">
                                        <div class="cr-price-wrapper">
                                            <div class="cr-price">
                                                <span class="cr-currency"><?php echo e(getCurrencySymbol()); ?></span>
                                                <span class="cr-amount"><?php echo e(number_format($course->pricing?->final_price, 2)); ?>  </span>
                                            </div>
                                            <!--[if BLOCK]><![endif]--><?php if(!empty($course->pricing?->price) && !empty($course->pricing?->discount)): ?>
                                                <del class="cr-discount"><?php echo e(number_format($course->pricing?->price, 2)); ?></del>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                        ...
                        <!-- Tutor profile section removed as requested -->
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\starlite\Modules/Courses\resources/views/livewire/course/course-detail.blade.php ENDPATH**/ ?>