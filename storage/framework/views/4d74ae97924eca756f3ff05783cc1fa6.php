...
$__html = app('livewire')->mount($__name, $__params, 'lw-3722846046-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3722846046-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3722846046-2', $__slots ?? [], get_defined_vars());
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                if (typeof Livewire !== 'undefined') {
                    ...
                    // Retry after a short delay if Livewire isn't ready yet
                    setTimeout(() => {
                        if (typeof Livewire !== 'undefined') {
                            initializeLivewireEvents();
                        }
...
<?php /**PATH C:\wamp64\www\starlite\resources\views/layouts/app.blade.php ENDPATH**/ ?>