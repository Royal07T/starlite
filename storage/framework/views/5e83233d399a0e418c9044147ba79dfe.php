            ...
            <div class="am-themeform__wrap">
                <div class="form-group-wrap">
                    <div class="form-group">
                        <label class="am-label"><?php echo e(__('Pricing Model')); ?></label>
                        <div class="am-radio-inline">
                            <div class="am-radio">
                                <input wire:model.live="pricing_type" type="radio" id="pricing_course" value="course">
                                <label for="pricing_course"><?php echo e(__('Course Price')); ?></label>
                            </div>
                            <div class="am-radio">
                                <input wire:model.live="pricing_type" type="radio" id="pricing_session" value="session">
                                <label for="pricing_session"><?php echo e(__('Session Price')); ?></label>
                            </div>
                        </div>
                    </div>

                    <!--[if BLOCK]><![endif]--><?php if($pricing_type == 'course'): ?>
                    <div class="form-group">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(!$isFree && $pricing_type == 'course'): ?>
                        <div class="form-group">
...
<?php endif; ?>
                                        ...
                                        <table class="am-table">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discountPercentage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td data-label="<?php echo e(__('courses::courses.discount_price')); ?>"><span>$<?php echo e(number_format(((float)$discountPercentage/100) * (float)$this->price, 2)); ?></span></td>
                                                    <td data-label="<?php echo e(__('courses::courses.purchase_price')); ?>"><span>$<?php echo e(number_format(((1 - ((float)$discountPercentage/100)) * (float)$this->price), 2)); ?></span></td>
                                                </tr>
                ...
                <!--[if BLOCK]><![endif]--><?php if($pricing_type == 'session'): ?>
                <div class="form-group-wrap" style="margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px;">
                    <div class="cr-content-box">
                        <h3><?php echo e(__('Session Pricing')); ?></h3>
                        <p><?php echo e(__('Set pricing for session-based booking. If set, students can book individual sessions.')); ?></p>
                    </div>
                    
                    <div class="form-group">
                         <label class="am-label" for="session-price"><?php echo e(__('Price Per Session')); ?></label>
                         <div class="at-form-group">
                         ...
                         <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['fieldName' => 'session_price']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['field_name' => 'session_price']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                    ...
                    <div class="form-group">
                         <label class="am-label" for="min-sessions"><?php echo e(__('Minimum Sessions Required')); ?></label>
                         <div class="at-form-group">
                             <input type="number" wire:model.live.debounce.500ms="min_sessions" id="min-sessions" placeholder="5" class="form-control">
                         </div>
                         <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['fieldName' => 'min_sessions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['field_name' => 'min_sessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php /**PATH C:\wamp64\www\starlite\Modules/Courses\resources/views/livewire/tutor/course-creation/components/course-pricing.blade.php ENDPATH**/ ?>