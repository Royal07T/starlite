                                            ...
                                            <div class="cr-course-card">
                                                ...
                                                <div class="cr-price-container">
                                                    <div class="cr-price-info">
                                                        <!--[if BLOCK]><![endif]--><?php if($course->pricing?->pricing_type == 'session'): ?>
                                                            <div class="cr-discounted-price">
                                                                <span class="cr-price-amount"><?php echo formatAmount($course->pricing?->session_price, true); ?></span>
                                                                <span style="font-size: 14px; color: #666;">/ <?php echo e(__('session')); ?></span>
                                                            </div>
                                                        <?php elseif(isPaidSystem() && !empty($course->pricing?->price) && !empty($course->pricing?->final_price) && $course->pricing?->price != 0.00 ): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\wamp64\www\starlite\Modules/Courses\resources/views/livewire/search/search-courses.blade.php ENDPATH**/ ?>