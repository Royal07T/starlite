                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="cr-card">
                        ...
                        <div class="cr-course-card">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($data->sessions_remaining > 0): ?>
                                <a href="<?php echo e(route('courses.student.course-booking', ['slug' => $course->slug])); ?>" class="cr-start-course" style="margin-top: 10px; background-color: #28a745; border-color: #28a745;">
                                    <?php echo e(__('Book Session')); ?> (<?php echo e($data->sessions_remaining); ?> Left)
                                </a>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                    </div>
...
<?php /**PATH C:\wamp64\www\starlite\Modules/Courses\resources/views/livewire/student/course-list/courselist.blade.php ENDPATH**/ ?>